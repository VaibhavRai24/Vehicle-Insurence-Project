...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        logging.info("Entered intiate_model_trainer method of model trainer parameter")
        """
        ...
        try:
            ...
            if accuracy_score(train_arr[:, -1], trained_model.predict(train_arr[:, :-1])) <self.model_trainer_config.expected_acurracy:
