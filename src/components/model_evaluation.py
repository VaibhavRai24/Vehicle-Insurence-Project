...
class ModelEvaluation:
    ...
    def get_best_model(self) ->Optional[Proj1Estimator]:
        ...
        try:
            ...
            if proj1_estimator.is_modal_present(model_path= model_path):
    ...
    def _map_gender_column(self, df):
        ...
        logging.info("Mapping gender col to binary values")
    ...
    def _rename_columns(self, df):
        """ Rename specific columns an ensure integer types for dummy colums"""
        logging.info("Renaming columns and ensuring integer types for dummy columns")
    ...
    def evaluate_model(self) ->EvaluateModelResponse:
        ...
        try:
            ...
            if best_model is not None:
                logging.info(f"Computing the f1 score for production satge")
                y_hat_best_model = best_model.predict(x)
                best_model_f1_score = f1_score(y, y_hat_best_model)
                logging.info(f"F1 score for best model{best_model_f1_score}")
